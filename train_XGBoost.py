...
joblib.dump(model, 'predictor/ml_models/xgboost_model.pkl')
...
print("\nModel saved!")
print("Regions the model knows:", le_region.classes_.tolist())
print("Soils the model knows:", le_soil.classes_.tolist())
print("Crops the model knows:", le_crop.classes_.tolist())
print("Weather the model knows:", le_weather.classes_.tolist())
